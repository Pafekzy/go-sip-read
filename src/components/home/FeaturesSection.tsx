...
export function FeaturesSection() {
  ...
  return <section className="py-16 bg-gradient-to-b from-background to-gosip-soft-purple/30">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => <Link to={feature.path} key={index} className="block hover:scale-105 transition-transform" onClick={handleFeatureClick(feature.path, false)}>
